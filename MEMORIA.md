...
## Versionamento
- **Versão atual: 1.1.0** — constante `APP_VERSION` em `index.html` (~linha 432), exibida na tela de login (`#login-version`).
...
- `isFullyAnswered()` (index.html) foi criada junto com os novos tipos de questão mas não é usada em nenhum lugar — candidata a remoção ou a uso real (ex.: avisar usuário se tentar finalizar com sub-itens incompletos).
